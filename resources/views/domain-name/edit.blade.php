                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form method="POST" action="{{route('domain-name.update',$domainName->id)}}" class="form-horizontal form-label-left">
                                @csrf @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="extension" type="text"
                                               ...
                                               name="extension" value="{{ $domainName->extension }}" required autocomplete="extension"
                                               autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="registration_fee" type="number"
                                               ...
                                               name="registration_fee" value="{{ $domainName->registration_fee }}" required autocomplete="price"
                                               autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="renewal_fee" type="number"
                                               ...
                                               name="renewal_fee" value="{{ $domainName->renewal_fee }}" required autocomplete="renewal_fee"
                                               autofocus>
