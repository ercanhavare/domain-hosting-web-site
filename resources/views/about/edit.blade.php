                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form method="POST" action="{{route('about.update',$about->id)}}" class="form-horizontal form-label-left">
                                @csrf @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="title" type="text"
                                               ...
                                               name="title" value="{{ $about->title }}" required autocomplete="title"
                                               autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <textarea id="desc" required="required"  class="form-control @error('desc') is-invalid @enderror"
                                                  ...
                                                  data-parsley-validation-threshold="10">{{ $about->desc }}</textarea>
