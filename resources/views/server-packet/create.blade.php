                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form method="POST" action="{{route('server-packet.store')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="cpu" type="text"
                                               ...
                                               name="cpu" value="{{ old('cpu') }}" required autocomplete="cpu"
                                               autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="ram" type="text"
                                               ...
                                               name="ram" value="{{ old('ram') }}" required autocomplete="ram"
                                               autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="hdd" type="text"
                                               ...
                                               name="hdd" value="{{ old('hdd') }}" required autocomplete="hdd"
                                               autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="internet" type="text"
                                               ...
                                               name="internet" value="{{ old('internet') }}" required autocomplete="internet"
                                               autofocus>
